...
# 2. train -- writes artifacts/, takes a few seconds
python train.py
...
Run all three from this directory. `artifacts/` is generated rather than
committed, so step 2 is required after cloning.
...
app/
  ...
  main.py             routes
artifacts/            generated by train.py -- not written by the API
